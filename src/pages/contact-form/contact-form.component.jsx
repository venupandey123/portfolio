    ...
    return (
        ...
        <Row>
          <Col className="d-flex justify-content-center flex-wrap">
            {/* buttons */}
            <div className="m-2">
              <a href="mailto:venupandey123@gmail.com" target="_blank" rel="noopener noreferrer">
                <Button variant="outline-danger" title="venupandey123@gmail.com">
           ...
           {/*  <div className="m-2">
            ...
            <div className="m-2">
              <a href="https://twitter.com/VenuGopalPande4" target="_blank" rel="noopener noreferrer">
            ...
            <div className="m-2">
              <a href="https://www.facebook.com/prianshuvenu.pandey" target="_blank" rel="noopener noreferrer">
